...
Subject.create(title: "Ingenieria de Software I", area: "Ciencias", professor: "Jose Oropeza", user_id: 2)
Subject.create(title: "Ingenieria de Software II", area: "Ciencias", professor: "Jose Oropeza", user_id: 1)
Subject.create(title: "Logica", area: "Ciencias", professor: "Zulma Revilla", user_id: 2)
